...
import styles from "./docSignIn.module.css";
...
export default class DocLogin extends Component {
  ...
  onHandleSubmit(e) {
    ...
    axios
      .post("/api/doctor/auth/login", doctor)
      .then((res) => {
        var items = [];
  ...
  render() {
    return (
      <div className={`${shared["container-div"]} ${styles["doc-signIn"]}`}>
        <h3 className={styles.label}>DOCTOR LOGIN</h3>
        {/* <div > */}
        <form
        ...
        >
          <div className={styles["input-group"]}>
            ...
            <input
              ...
              onChange={this.onChangeHospitalCode}
            />
          </div>
          <div className={styles["input-group"]}>
